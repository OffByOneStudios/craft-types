...
CRAFT_MULTIMETHOD_DEFINE(syn::isSubtypeMethod)
{
...
bool syn::isSubtype(Graph::Node* left, Graph::Node* right)
{
	if (left == right)
		return true;
...
bool syn::isSubtype(IExpression const* left, IExpression const* right)
{
